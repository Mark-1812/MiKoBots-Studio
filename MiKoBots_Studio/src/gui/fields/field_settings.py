...
class SettingsField(QWidget):
    ...
    def GUI(self):
        ...
        self.slider_speed = SettingSlider(layout, 0, 5, 150, "Jog speed") 
        self.slider_accel = SettingSlider(layout, 1, 5, 150, "Jog accel")
        self.slider_jog = SettingSlider(layout, 2, 5, 150, "Jog distance")
        ...
        self.controller_button.setFixedSize(40,40)
        ...
        layout.addWidget(self.controller_button, 2,0)
        
        self.controller_state = QLabel("")
        self.controller_state.setAlignment(Qt.AlignLeft)
        layout.addWidget(self.controller_state,2,1)
        ...
        layout.addWidget(self.button_settings_robot,1,1)
        ...
        layout.addWidget(self.button_settings_send,1,2)
        ...
        layout.addWidget(self.vision_button, 1, 3)         
    ...
    def SetRobotCombo(self, robot):
        ...
        self.combo_robot.blockSignals(True)
        self.combo_robot.setCurrentIndex(robot)
        self.combo_robot.blockSignals(False)
    ...
    def ShowRobotWindow(self):
        ...
        self.RobotWindow.RobotTools.open_plotter()
