...
from PyQt5.QtWidgets import QButtonGroup, QRadioButton, QPushButton, QCheckBox, QVBoxLayout, QSizePolicy, QSpacerItem, QFileDialog, QFrame, QGridLayout, QTextEdit, QScrollBar, QLineEdit, QWidget
