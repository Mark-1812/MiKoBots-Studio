...
from PyQt5.QtWidgets import QScrollArea, QVBoxLayout, QPushButton, QLabel, QCheckBox, QComboBox, QSizePolicy, QApplication, QFileDialog, QFrame, QGridLayout, QTextEdit, QScrollBar, QLineEdit, QWidget

from gui.style import * 

from backend.core.event_manager import event_manager

class ControlIO(QFrame):
    def __init__(self):
        super().__init__()
    ...
    def FrameIo(self):
        ...
        scroll_widget.setMaximumWidth(200)
