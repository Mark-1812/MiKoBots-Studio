...
class RobotTools(QWidget):
    ...
    def GUI(self):
        ...
        scroll_area2.setStyleSheet(style_scrollarea)
        ...
        self.checkbox_cam.setStyleSheet(style_checkbox)
        ...
        layout_options.addWidget(self.button_save_robot, row + 5, 0, 1, 4)
