...
from gui.tabs_field.gcode.gcode_frame import GcodeFrame
from gui.tabs_field.robot_tab.robot_frame import RobotFrame
from gui.tabs_field.vision.vision_frame import VisionFrame
from gui.tabs_field.simulation.simulation_frame import SimulationGUI
