...
class VisionManagement():
    ...
    def calculate_mm_per_pixel(self, image = None, Height = None):
        ...
        if self.cam_tool:
            settings_cam = var.TOOL_CAM_SETTINGS
    ...
    def ShowCalSquare(self, image):
        ...
        top_left = (x_1, y_1)
        bottom_right = (x_1 + w_1, y_1 + h_1)
        top_right = (x_1 + w_1, y_1)
        bottom_left = (x_1, y_1 + h_1)
        
        cv2.line(image, top_left, bottom_right, (255, 0, 0), 2)
        cv2.line(image, top_right, bottom_left, (255, 0, 0), 2)
